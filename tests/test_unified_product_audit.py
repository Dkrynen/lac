...
def test_authenticated_client_surface_does_not_claim_hosted_execution():
    assert enabled_cloud_execution_gates({
        "authenticated_client_surface": True,
        "provider_broker": False,
        "provider_metering": False,
        "infrastructure_metering": False,
        "hosted_workspace_execution": False,
    }) == []
