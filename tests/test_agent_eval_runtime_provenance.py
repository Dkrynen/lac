...
def snapshot(*, version="1.18.4", sha256=OPENCODE_SHA256):
    return SimpleNamespace(
...
def test_attestation_accepts_exact_allowlisted_runtime_contract():
    ...
    assert result["executable"] == {
        "platform": "windows",
        "architecture": "amd64",
        "reviewed_build_id": "opencode-1.18.4-windows-amd64-native",
        "version": "1.18.4",
...
@pytest.mark.parametrize(
    ...
    (
        (("linux", "amd64"), "opencode-1.18.4-windows-amd64-native"),
        (("windows", "arm64"), "opencode-1.18.4-windows-amd64-native"),
